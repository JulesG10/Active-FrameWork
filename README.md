...
Go  [includes/config/config.active.json](https://github.com/JulesG10/Active-FrameWork/blob/master/example/ex04.html) and change has you want for genarate your page
